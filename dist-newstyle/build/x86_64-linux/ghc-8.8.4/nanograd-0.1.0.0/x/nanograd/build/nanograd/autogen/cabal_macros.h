...
/* package nanograd-0.1.0.0 */
#ifndef VERSION_nanograd
#define VERSION_nanograd "0.1.0.0"
#endif /* VERSION_nanograd */
#ifndef MIN_VERSION_nanograd
#define MIN_VERSION_nanograd(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_nanograd */
...
#define CURRENT_COMPONENT_ID "nanograd-0.1.0.0-inplace-nanograd"
